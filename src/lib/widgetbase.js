...
import {Tab, Tabs, Button, Select, MenuItem, 
    Dialog, DialogTitle, DialogContent, DialogActions, 
    FormControl, TextField, IconButton,
    Card, CardContent, CardHeader, CardActions} from '@material-ui/core';
    ...
    render() {
        return (
            ...
            {this.state.tabIndex === 1 && <TabContainer>
                <FormControl>
                    <Select value={this.props.settings.datasource} 
                    onChange={event => this.props.onSettingsChange('datasource', event.target.value)}>
            ...
            {this.state.tabIndex === 0 && <TabContainer>
                <TextField
                    ...
                    onChange={event => this.props.onSettingsChange('title', event.target.value)}
                    margin="normal"
                    />
                </TabContainer>}
            </div>
...
const withSettingsDialog = SettingsComponent => class extends React.Component {
    constructor(props) {
        super(props)
    ...
    handleSettingsChange = (name, value) => this.setState(
    ...
    render() {
        return (
          ...
          >
            ...
            <DialogContent>
                <SettingsComponent {...this.props} settings={this.state.settings} 
...
const withWidget = (WidgetComponent, SettingsComponent) => class extends React.Component {
    constructor(props) {
        super(constructor);
        this.state = {
        ...
        return (
            <Card>
                ...
                <div>
                    ...
                    onDialogClosed={() => this.setState({isSettingDialogOpen: false})}
